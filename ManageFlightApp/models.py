...
if __name__ == '__main__':
    with app.app_context():
        ...
        r1 = Route(name='TP.HCM - HÀ NỘI', distance=1190, flight_time_min=8, number_of_airport=2,
                   arrival_id=2, departure_id=1)
        r2 = Route(name='TP.HCM - Đà Nẵng', distance=590, flight_time_min=8, number_of_airport=0,
                   arrival_id=4, departure_id=1)
        r3 = Route(name='Đà Nẵng - Hải Phòng', distance=200, flight_time_min=8, number_of_airport=0,
                   arrival_id=3, departure_id=4)
        r4 = Route(name='Hải Phòng - HÀ NỘI', distance=400, flight_time_min=8, number_of_airport=0,
                   arrival_id=2, departure_id=3)
        r5 = Route(name='TP.HCM - Cà Mau', distance=1190, flight_time_min=8, number_of_airport=2,
                   arrival_id=5, departure_id=1)
        r6 = Route(name='SaPa - Phan thiết', distance=1190, flight_time_min=5, number_of_airport=1,
                   arrival_id=10, departure_id=7)
        r7 = Route(name='Phan Thiết - Vũng tàu', distance=1190, flight_time_min=8, number_of_airport=0,
                   arrival_id=9, departure_id=10)
        r8 = Route(name='Tây Ninh - Sapa', distance=1190, flight_time_min=10, number_of_airport=2,
                   arrival_id=7, departure_id=6)
        r9 = Route(name='Đà Lạt - TP.HCM', distance=1190, flight_time_min=8, number_of_airport=0,
                   arrival_id=1, departure_id=8)
        r10 = Route(name='Vũng Tàu - Đà Lạt', distance=1190, flight_time_min=8, number_of_airport=0,
                    arrival_id=8, departure_id=9)
        r11 = Route(name='Đà nẵng - Đà Lạt', distance=1190, flight_time_min=8, number_of_airport=0,
                    arrival_id=8, departure_id=9)
        ...
        f2 = Flight(route_id=8, departure_time='2023-1-31 13:30:00', arrival_time='2024-02-1 23:30:00')
        f3 = Flight(route_id=6, departure_time='2024-1-20 18:00:00', arrival_time='2024-1-8 23:00:00')
        f4 = Flight(route_id=1, departure_time='2023-12-31 10:00:00', arrival_time='2023-12-31 19:00:00')
        f5 = Flight(route_id=1, departure_time='2024-1-20 9:00:00', arrival_time='2024-1-8 17:00:00')
        f6 = Flight(route_id=8, departure_time='2023-12-31 9:00:00', arrival_time='2023-12-31 19:00:00')
        f7 = Flight(route_id=1, departure_time='2023-12-31 2:00:00', arrival_time='2023-12-31 11:00:00')
        f8 = Flight(route_id=11, departure_time='2024-1-20 9:00:00', arrival_time='2024-1-8 17:00:00')
